...
/**
 * Utility class to generate Namecard DTOs
 */
@Component
public class NameUtils {
    ...
    public static final int ADJ_LENGTH = NameUtils.adjective.length;
    public static final int NAME = NameUtils.person.length;
